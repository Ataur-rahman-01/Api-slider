...
const showImages = (images) => {
  ...
  images.forEach((image) => {
    ...
    div.innerHTML = ` <img class="zoom img-fluid img-thumbnail" onclick=selectItem(event,"${image.webformatURL}") src="${image.webformatURL}" alt="${image.tags}"> `;
